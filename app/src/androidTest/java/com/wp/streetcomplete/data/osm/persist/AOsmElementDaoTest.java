...
import de.westnordost.backbiking.data.osm.persist.AOsmElementDao;
import de.westnordost.backbiking.data.osm.persist.OsmQuestTable;
...
public class AOsmElementDaoTest
{
	...
	@Test public void putGet()
	{
		...
		Assert.assertEquals(6,dao.get(6).getId());
		Assert.assertEquals(1,dao.get(6).getVersion());
	}
	...
	@Test public void putOverwrite()
	{
		...
		Assert.assertEquals(5,dao.get(6).getVersion());
	}
