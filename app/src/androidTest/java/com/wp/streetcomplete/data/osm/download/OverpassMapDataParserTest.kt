package de.wp.streetcomplete.data.osm.download
...
class OverpassMapDataParserTest {
	...
	private fun parse(xml: String): List<de.wp.streetcomplete.data.osm.download.OverpassMapDataParserTest.ElementWithGeometry> {
		val parser = OverpassMapDataParser(OsmMapDataFactory())
		val result = mutableListOf<de.wp.streetcomplete.data.osm.download.OverpassMapDataParserTest.ElementWithGeometry>()
		parser.setHandler { element, geometry ->
			result.add(de.wp.streetcomplete.data.osm.download.OverpassMapDataParserTest.ElementWithGeometry(element, geometry))
		}
